...
function addSeasonalObjects(world: World, map: ServerMap, season: Season, holiday: Holiday) {
	...
	const isValentine = holiday === Holiday.Valentine;
	...
	if (isValentine) {
		add (entities.rose2(73.75, 73.79));
add (entities.rose2(74.69, 73.33));
add (entities.rose2(75.38, 74.46));
add (entities.rose2(75.13, 73.67));
add (entities.rose2(74.31, 73.50));
add (entities.rose2(75.00, 75.00));
add (entities.rose2(74.50, 75.38));
add (entities.rose2(74.09, 75.67));
add (entities.rose2(73.69, 75.79));
add (entities.rose2(73.22, 75.46));
add (entities.rose2(72.81, 74.75));
add (entities.rose2(72.47, 74.21));
add (entities.rose2(72.31, 73.46));
add (entities.rose2(72.69, 73.21));
add (entities.rose2(73.09, 73.25));
add (entities.rose2(73.44, 73.50));
add (entities.valentinesign(73.91, 74.17));
add (entities.collider1x1(73.47, 74.79));
add (entities.collider1x1(73.47, 74.38));
add (entities.collider1x1(73.31, 73.67));
add (entities.collider1x1(72.97, 74.42));
add (entities.heart(73.84, 74.46));
add (entities.heart(73.88, 75.13));
add (entities.heart(50.06, 19.08));
add (entities.heart(59.94, 19.04));
add (entities.heart(59.97, 28.96));
add (entities.heart(50.03, 29.04));
	...
	if (isSpring || isSummer) {
		add (entities.flowerbl(74.66, 82.79));
add (entities.flowerbl(61.16, 91.67));
add (entities.flowerbl(85.19, 93.38));
add (entities.flowerbl(85.34, 76.58));
add (entities.flowerbl(94.69, 89.00));
add (entities.flowerbl(99.31, 92.50));
add (entities.flowerbl(114.97, 83.83));
add (entities.flowerbl(103.50, 75.08));
add (entities.flowerbl(92.16, 67.67));
add (entities.flowerbl(68.75, 70.50));
add (entities.flowerbl(60.53, 66.96));
add (entities.flowerbl(67.34, 42.92));
add (entities.flowerbl(59.63, 47.08));
add (entities.flowerbl(65.34, 33.88));
add (entities.flowerbl(75.78, 49.71));
add (entities.flowerbl(89.53, 48.96));
add (entities.flowerbl(100.53, 35.46));
add (entities.flowerbl(110.47, 57.17));
add (entities.flowerbl(121.53, 46.88));
add (entities.flowerbl(143.72, 56.83));
add (entities.flowerbl(151.06, 44.17));
add (entities.flowerbl(130.94, 47.04));
add (entities.flowerbl(156.78, 29.54));
add (entities.flowerbl(137.31, 30.00));
add (entities.flowerbl(150.06, 14.46));
add (entities.flowerbl(144.91, 9.13));
add (entities.flowerbl(144.06, 19.13));
add (entities.flowerbl(131.53, 12.71));
add (entities.flowerbl(118.91, 10.42));
add (entities.flowerbl(113.38, 12.42));
add (entities.flowerbl(97.63, 2.33));
add (entities.flowerbl(82.91, 12.21));
add (entities.flowerbl(80.44, 3.13));
add (entities.flowerbl(68.75, 5.13));
add (entities.flowerbl(69.53, 15.21));
add (entities.flowerbl(52.03, 4.92));
add (entities.flowerbl(48.06, 12.71));
add (entities.flowerbl(34.16, 4.54));
add (entities.flowerbl(28.75, 14.83));
add (entities.flowerbl(15.81, 6.63));
add (entities.flowerbl(11.97, 25.33));
add (entities.flowerbl(21.34, 28.04));
add (entities.flowerbl(23.81, 41.21));
add (entities.flowerbl(11.44, 48.21));
add (entities.flowerbl(8.59, 58.08));
add (entities.flowerbl(25.66, 60.46));
add (entities.flowerbl(30.34, 67.79));
add (entities.flowerbl(22.22, 76.88));
add (entities.flowerbl(25.75, 86.75));
add (entities.flowerbl(15.53, 97.54));
add (entities.flowerbl(7.97, 108.04));
add (entities.flowerbl(22.56, 115.75));
add (entities.flowerbl(5.03, 131.92));
add (entities.flowerbl(12.22, 144.13));
add (entities.flowerbl(43.00, 138.25));
add (entities.flowerbl(37.16, 127.08));
add (entities.flowerbl(49.84, 122.79));
add (entities.flowerbl(63.00, 128.96));
add (entities.flowerbl(64.28, 123.25));
add (entities.flowerbl(62.53, 121.79));
add (entities.flowerbl(97.34, 111.54));
add (entities.flowerbl(85.84, 102.46));
add (entities.flowerbl(67.94, 99.96));
add (entities.flowerbl(56.25, 99.88));
add (entities.flowerbl(45.03, 95.67));
add (entities.flowery(47.22, 98.63));
add (entities.flowery(63.19, 103.42));
add (entities.flowery(77.00, 93.50));
add (entities.flowery(72.88, 102.79));
add (entities.flowery(92.19, 90.38));
add (entities.flowery(98.69, 103.50));
add (entities.flowery(108.75, 105.21));
add (entities.flowery(121.31, 93.92));
add (entities.flowery(131.50, 92.63));
add (entities.flowery(135.44, 105.17));
add (entities.flowery(142.03, 93.33));
add (entities.flowery(156.72, 101.54));
add (entities.flowery(145.69, 114.63));
add (entities.flowery(155.53, 122.54));
add (entities.flowery(143.44, 130.83));
add (entities.flowery(139.75, 146.54));
add (entities.flowery(123.09, 147.92));
add (entities.flowery(122.53, 155.21));
add (entities.flowery(108.41, 150.54));
add (entities.flowery(102.34, 155.71));
add (entities.flowery(71.69, 146.21));
add (entities.flowery(58.81, 153.83));
add (entities.flowery(47.56, 143.42));
add (entities.flowery(39.25, 156.63));
add (entities.flowery(25.22, 129.96));
add (entities.flowery(18.75, 120.58));
add (entities.flowery(17.69, 100.83));
add (entities.flowery(29.34, 85.67));
add (entities.flowery(37.88, 67.17));
add (entities.flowery(50.44, 68.04));
add (entities.flowery(64.28, 63.21));
add (entities.flowery(66.03, 68.42));
add (entities.flowery(88.81, 68.08));
add (entities.flowery(83.94, 57.21));
add (entities.flowery(110.56, 60.67));
add (entities.flowery(107.41, 57.38));
add (entities.flowery(137.00, 48.75));
add (entities.flowery(122.16, 50.54));
add (entities.flowery(146.25, 42.50));
add (entities.flowery(143.56, 9.38));
add (entities.flowery(149.00, 14.46));
add (entities.flowery(142.63, 18.92));
add (entities.flowery(133.00, 7.88));
add (entities.flowery(127.97, 7.79));
add (entities.flowery(126.53, 13.21));
add (entities.flowery(113.41, 16.46));
add (entities.flowery(103.19, 19.54));
add (entities.flowery(81.72, 16.38));
add (entities.flowery(70.88, 13.58));
add (entities.flowery(76.94, 20.00));
add (entities.flowery(69.41, 3.33));
add (entities.flowery(51.06, 6.88));
add (entities.flowery(37.84, 13.38));
add (entities.flowery(29.75, 4.08));
add (entities.flowery(18.31, 6.67));
add (entities.flowery(11.94, 15.29));
add (entities.flowery(12.69, 28.29));
add (entities.flowery(22.31, 30.00));
add (entities.flowery(15.50, 41.33));
add (entities.flowery(5.25, 43.63));
add (entities.flowery(10.50, 53.96));
add (entities.flowery(21.28, 61.46));
add (entities.flowery(20.38, 81.21));
add (entities.flowery(43.94, 81.29));
add (entities.flowery(67.06, 131.50));
add (entities.flowery(55.72, 124.13));
add (entities.flowery(66.47, 151.67));
add (entities.flowerbl(47.66, 146.58));
add (entities.flowerbl(61.72, 145.08));
add (entities.flowerbl(68.06, 156.25));
add (entities.flowerbl(31.50, 148.29));
add (entities.flowerbl(21.63, 148.79));
add (entities.flowerbl(102.03, 148.83));
add (entities.flowerbl(113.75, 155.42));
add (entities.flowerbl(118.22, 146.00));
add (entities.flowerbl(132.50, 157.88));
add (entities.flowerbl(144.91, 156.67));
add (entities.flowerbl(153.50, 146.63));
...
export function createMainMap(world: World): ServerMap {
	...
	// new
	add (entities.cookieTable2(49.50, 24.57));
	add (entities.bench1(134.78, 66.77));
	add (entities.boxFruits(49.50, 22.05));
	add (entities.fence3(128.01, 68.63));
	add (entities.fence3(127.97, 71.10));
	addEntities(entities.tree5(132.48, 65.55, 0));
	addEntities(entities.tree5(136.82, 65.27, 0));
	addEntities(entities.tree5(137.43, 68.78, 0));
	addEntities(entities.tree5(133.99, 70.55, 0));
	addEntities(entities.fullBoat(126.75, 65.17));
	add (entities.lanternOnWall(128.59, 65.75));
	add (entities.lanternOnWall(124.78, 65.50));
	add (entities.muffin(51.56, 19.29));
add (entities.muffin(52.44, 19.25));
add (entities.muffin(52.53, 18.71));
add (entities.muffin(51.13, 18.63));
add (entities.muffin(51.97, 19.08));
add (entities.muffin(51.34, 18.83));
add (entities.muffin(51.06, 19.08));
add (entities.muffin(51.75, 17.83));
add (entities.muffin(51.22, 18.08));
add (entities.muffin(52.59, 17.88));
add (entities.muffin(52.16, 17.83));
add (entities.muffin(52.78, 18.25));
add (entities.muffin(51.63, 18.08));
add (entities.muffin(52.44, 18.08));
	
	// new2
	add (entities.bench1(34.38, 95.63));
	add (entities.bench1(38.03, 95.75));
	add (entities.benchSeatH(41.78, 97.08));
	add (entities.benchSeatH(42.31, 97.08));
	add (entities.benchBackH2(42.75, 99.71));
	add (entities.table2(40.53, 98.46));
	add (entities.lanternOn(31.31, 96.25));
	add (entities.lanternOn(31.31, 100.29));
	add (entities.lanternOn(36.00, 95.54));
	add (entities.lanternOn(35.88, 100.83));
	add (entities.lanternOn(39.53, 95.46));
	add (entities.lanternOn(39.44, 100.92));
	add (entities.bookshelf(41.03, 95.50));
	add (entities.lanternOnTable(40.53, 98.63));
	add (entities.cushion2(33.91, 101.33));
	add (entities.cushion2(33.88, 100.21));
	add (entities.cushion2(35.22, 100.33));
	add (entities.cushion2(35.22, 101.21));
	add (entities.cushion2(36.59, 100.21));
	add (entities.cushion2(38.84, 100.29));
	add (entities.cushion2(37.44, 100.21));
	add (entities.stoneWallFull(80.25, 50.88));
	add (entities.stoneWallFull(82.75, 50.88));
	add (entities.stoneWallBeamV1(83.91, 48.58));
	add (entities.stoneWallBeamV1(83.91, 46.42));
	add (entities.stoneWallBeamV1(79.09, 46.21));
	add (entities.stoneWallBeamV1(79.06, 48.67));
	add (entities.cushion3(79.94, 46.67));
	add (entities.cushion3(79.78, 48.67));
	add (entities.cushion3(82.50, 46.92));
	add (entities.cushion3(82.44, 48.29));
	add (entities.cushion3(82.59, 49.25));
	add (entities.cushion3(79.84, 47.54));
	add (entities.table1(8.25, 36.00));
add (entities.table1(8.25, 35.00));
add (entities.table1(150.34, 31.54));
add (entities.table1(150.34, 28.13));
add (entities.table1(148.38, 28.08));
add (entities.table1(148.44, 31.63));
add (entities.table1(141.50, 28.00));
add (entities.table1(141.63, 31.33));
add (entities.table1(143.50, 27.88));
add (entities.table1(143.38, 31.25));
add (entities.table2(146.06, 27.29));
add (entities.cushion3(145.41, 25.21));
add (entities.cushion3(146.19, 25.21));
add (entities.cushion3(146.81, 25.21));
add (entities.cushion2(148.34, 28.13));
add (entities.cushion2(150.34, 28.17));
add (entities.cushion2(150.34, 31.54));
add (entities.cushion2(148.38, 31.63));
add (entities.cushion2(143.34, 31.25));
add (entities.cushion2(141.66, 31.25));
add (entities.cushion2(141.44, 27.96));
add (entities.cushion2(143.44, 27.92));
add (entities.bookshelf(150.72, 25.38));
add (entities.bookshelf(141.09, 25.17));
add (entities.lanternOn(141.47, 24.67));
add (entities.lanternOn(151.03, 24.88));
add (entities.lanternOn(146.16, 27.33));
add (entities.lanternOn(148.44, 27.75));
add (entities.lanternOn(150.41, 27.71));
add (entities.lanternOn(150.31, 31.13));
add (entities.lanternOn(148.47, 31.25));
add (entities.lanternOn(143.47, 31.00));
add (entities.lanternOn(141.72, 30.83));
add (entities.lanternOn(141.56, 27.71));
add (entities.lanternOn(143.38, 27.50));
add (entities.lanternOn(145.78, 27.38));
add (entities.spider(47.25, 28.42));
add (entities.bench1(34.38, 95.63));
add (entities.bench1(38.03, 95.75));
add (entities.benchSeatH(41.78, 97.08));
add (entities.benchSeatH(42.31, 97.08));
...
add (entities.cushion3(82.59, 49.25));
add (entities.cushion3(79.84, 47.54));
add (entities.bench1(76.38, 16.08));
add (entities.cushion1(75.63, 16.25));
add (entities.cushion1(77.00, 16.17));
add (entities.cushion1(8.34, 32.50));
add (entities.cushion1(10.00, 32.50));
add (entities.cushion1(10.00, 37.58));
add (entities.cushion1(8.28, 37.54));
add (entities.table1(10.00, 34.40));
add (entities.table1(9.97, 37.63));
add (entities.table1(8.25, 37.00));
add (entities.cushion3(6.78, 34.46));
add (entities.cushion3(6.78, 35.17));
add (entities.benchBackH(6.16, 36.54));
add (entities.benchSeatH(6.44, 33.83));
add (entities.benchSeatH(6.94, 33.83));
add (entities.table1(8.25, 36.00));
add (entities.table1(8.25, 35.00));
	...
	// restaurant
	add (entities.table2(61.88, 83.83));
	add (entities.table2(66.09, 83.83));
	add (entities.table2(66.06, 80.33));
	add (entities.table2(61.78, 80.38));
	add (entities.cushion3(60.47, 79.29));
	add (entities.cushion3(60.47, 80.83));
	add (entities.cushion3(63.09, 79.33));
	add (entities.cushion3(63.13, 80.71));
	add (entities.cushion2(60.38, 82.83));
	add (entities.cushion2(60.41, 84.08));
	add (entities.cushion2(63.22, 82.79));
	add (entities.cushion2(63.28, 84.25));
	add (entities.cushion1(64.78, 79.63));
	add (entities.cushion1(64.72, 80.71));
	add (entities.cushion1(67.34, 79.71));
	add (entities.cushion1(67.34, 80.83));
	add (entities.cushion1(64.69, 83.13));
	add (entities.cushion1(64.66, 84.58));
	add (entities.cushion1(67.22, 83.25));
	add (entities.cushion1(67.31, 84.63));
	add (entities.cushion2(64.69, 84.04));
	add (entities.cushion2(64.69, 83.88));
	add (entities.cushion2(67.28, 83.96));
	add (entities.cushion2(67.34, 84.54));
	add (entities.cushion2(67.34, 83.88));
	add (entities.cushion2(67.34, 83.67));
	add (entities.coffeedisp(61, 76));
	add (entities.boxFruits(66.66, 76.25));
	add (entities.cookieTable(65.63, 76.38));
	add (entities.cookieTable2(63.84, 76.29));
	add (entities.lemonadedisp(62.25, 76.66));
	add (entities.table1(61.72, 78.13));
	add (entities.table1(66.00, 78.13));
	add (entities.cushion3(60.78, 77.38));
	add (entities.cushion3(62.66, 77.38));
	add (entities.cushion1(65.06, 77.17));
	add (entities.cushion1(66.94, 77.29));
	add (entities.lanternOnTable(61.88, 80.75));
	add (entities.lanternOnTable(61.94, 83.88));
	add (entities.lanternOnTable(66.09, 84.25));
	add (entities.lanternOnTable(66.06, 80.67));
	
	// library
	add (entities.house(38.00, 152.88));
	add (entities.bookshelf(23.00, 144.33));
	add (entities.bookshelf(28.94, 144.25));
	add (entities.bookshelf(25.94, 144.46));
	add (entities.cushion1(23.94, 147.08));
	add (entities.cushion1(23.91, 150.58));
	add (entities.cushion1(28.81, 147.08));
	add (entities.cushion1(28.75, 150.50));
	add (entities.table1(24.84, 147.96));
	add (entities.table1(24.84, 151.42));
	add (entities.table1(27.69, 151.42));
	add (entities.table1(27.78, 147.92));
	add (entities.cushion2(26.84, 147.13));
	add (entities.cushion2(25.81, 147.13));
	add (entities.cushion2(26.75, 150.46));
	add (entities.cushion2(25.75, 150.50));
	add (entities.lanternOnTable(24.78, 151.50));
	add (entities.lanternOnTable(27.63, 151.50));
	add (entities.lanternOnTable(27.78, 148.00));
	add (entities.lanternOnTable(24.81, 148.00));
	add (entities.lanternOn(27.41, 144.54));
	add (entities.lanternOn(24.41, 144.50));
	
	// store
	add (entities.boxFruits(106.75, 65.04));
	add (entities.boxLanterns(110.22, 64.96));
	add (entities.cookieTable(108.47, 64.83));
	add (entities.crate1A(110.25, 67.04));
	add (entities.table1(106.66, 67.96));
	add (entities.table1(110.28, 67.88));
	add (entities.broom(106.66, 68.29));
	add (entities.hammer(110.28, 68.21));
	add (entities.lanternOnTable(110.22, 67.96));
	add (entities.lanternOnTable(106.66, 68.00));
	add (entities.toolboxFull(106.75, 66.29));
	add (entities.ropeRack(110.25, 68.08));
	
	// palace 
	add (entities.stoneWallFull(131.72, 4.00));
add (entities.stoneWallFull(129.38, 4.00));
add (entities.stoneWallFull(127.06, 4.00));
add (entities.stoneWallBeamV1(126.03, 4.08));
add (entities.stoneWallBeamV1(132.75, 4.17));
add (entities.stoneWallBeamV1(132.75, 5.46));
add (entities.stoneWallBeamV1(126.03, 5.38));
add (entities.stoneWallBeamV1(132.75, 6.79));
add (entities.stoneWallBeamV1(126.03, 6.92));
add (entities.stoneWallFull(131.75, 8.17));
add (entities.stoneWallFull(127.06, 8.13));
add (entities.lanternOnWall(126.03, 4.46));
add (entities.lanternOnWall(132.75, 4.42));
add (entities.cushion3(129.00, 4.58));
add (entities.cushion3(129.56, 4.63));
add (entities.cushion3(130.47, 4.63));
add (entities.cushion3(130.50, 5.25));
add (entities.cushion3(129.59, 5.33));
add (entities.cushion3(129.00, 5.33));


	
	// benches
	add (entities.cushion1(50.31, 88.13));
	add (entities.cushion1(49.22, 88.13));
	add (entities.cushion1(49.25, 87.54));
	add (entities.cushion1(50.34, 87.58));
	add (entities.cushion1(49.78, 88.04));
	add (entities.cushion1(49.81, 87.79));
	add (entities.cushion1(47.41, 31.54));
	add (entities.cushion1(46.19, 31.54));
	add (entities.cushion1(44.69, 31.50));
	add (entities.cushion1(43.44, 31.50));
	add (entities.bench1(136.88, 118.75));
	add (entities.bench1(150.16, 99.04));
	addEntities(entities.tree(150.94, 106.54, 0));
	addEntities(entities.tree(141.22, 101.13, 0));
	addEntities(entities.tree(141.19, 104.83, 0));
	addEntities(entities.tree(140.00, 101.08, 0));
	addEntities(entities.tree(140.06, 104.92, 0));
	addEntities(entities.tree(24.03, 29.04, 0));
	addEntities(entities.tree(20.69, 23.50, 0));
	addEntities(entities.tree(18.16, 26.00, 0));
	add (entities.cushion1(86.28, 3.38));
	add (entities.cushion1(87.69, 3.38));
	add (entities.cushion1(101.34, 8.42));
	add (entities.cushion1(102.56, 8.42));
	add (entities.cushion1(141.44, 11.54));
	add (entities.cushion1(142.81, 11.54));
	add (entities.cushion1(144.13, 11.63));
	add (entities.cushion1(145.50, 11.67));
	add (entities.cushion1(146.97, 13.13));
	add (entities.cushion1(146.88, 14.88));
	add (entities.cushion1(123.06, 53.13));
	add (entities.cushion1(124.41, 53.13));
	add (entities.cushion1(126.28, 53.13));
	add (entities.cushion1(127.75, 53.13));
	add (entities.cushion1(134.06, 66.83));
	add (entities.cushion1(135.41, 66.88));
	add (entities.cushion1(116.56, 62.29));
	add (entities.cushion1(117.91, 62.21));
	add (entities.cushion1(136.22, 118.79));
	add (entities.cushion1(137.53, 118.79));
	add (entities.cushion1(147.34, 138.96));
	add (entities.cushion1(145.94, 138.92));
	add (entities.cushion1(144.84, 139.00));
	add (entities.cushion1(143.38, 138.92));
	add (entities.cushion1(136.59, 151.42));
	add (entities.cushion1(136.56, 153.00));
	add (entities.cushion1(133.84, 150.79));
	add (entities.cushion1(132.50, 150.79));
	add (entities.cushion1(129.31, 151.50));
	add (entities.cushion1(129.31, 152.96));
	add (entities.cushion1(92.84, 146.38));
	add (entities.cushion1(94.19, 146.38));
	add (entities.cushion1(28.59, 104.33));
	add (entities.cushion1(27.22, 104.33));
	add (entities.cushion1(27.50, 117.46));
	add (entities.cushion1(27.44, 118.92));
	add (entities.cushion1(19.34, 88.54));
	add (entities.cushion1(17.97, 88.58));
	add (entities.cushion1(25.97, 70.54));
	add (entities.cushion1(24.53, 70.54));
	add (entities.cushion1(23.16, 70.54));
	add (entities.cushion1(21.84, 70.54));
	add (entities.cushion1(29.34, 29.54));
	add (entities.cushion1(30.69, 29.54));
	addEntities(entities.tree(144.50, 14.63, 0));
	add (entities.sign(33.53, 94.21));
	add (entities.sign(64.75, 76.04));


	
	// office
	add (entities.house(55.63, 19.21)).interact = (_, client) => goToMap(world, client, 'custom',);
	add(entities.triggerHouseDoor(54.84, 19.17)).trigger = (_, client) => goToMap(world, client, 'custom',);
	
	// tardis
	add (entities.tardis(26.03, 46.54));
add (entities.collider1x1(26.28, 45.63));
add (entities.collider1x1(25.63, 45.42));
add (entities.collider1x1(26.91, 45.29));
add (entities.collider1x1(25.66, 45.79));
add (entities.collider1x1(25.59, 45.00));
add (entities.collider1x1(25.59, 45.58));
add (entities.collider1x1(25.59, 44.29));
add (entities.collider1x1(27.09, 46.13));
add (entities.collider1x1(25.16, 45.33));
add (entities.collider1x1(24.88, 45.25));
add (entities.triggerHouseDoor(26.22, 46.83)).trigger = (_, client) => goToMap(world, client, 'tardisMap',);
add (entities.logo(54.84, 30.33));

	
	add (entities.house(46.81, 20.63)).interact = (_, client) => goToMap(world, client, 'discomap',);
	add(entities.triggerHouseDoor(46.13, 20.58)).trigger = (_, client) => goToMap(world, client, 'discomap',);
	...
	add(createSignWithText(70.5, 70.5, 'derpystown', '      derpystown\n[under construction]', entities.sign));
	...
	add(createSign(52, 19, 'muffin dispenser sign', give(entities.muffin.type, `Here's your muffin!`), entities.sign));
