...
export const NEW_ACCOUNT_PONY_NAME = 'NewPony';

export const PONY_TYPE = 1;
export const PONY_SPEED_TROT = 5; // tiles per sec
...
export const AFK_TIMEOUT = 60 * MINUTE;
export const REMOVE_TIMEOUT = 60 * MINUTE;
export const REMOVE_INTERVAL = 1 * MINUTE;
export const MAP_DISCARD_TIMEOUT = 60 * MINUTE;
...
export const PLAYER_NAME_MAX_LENGTH = 300;
export const PLAYER_DESC_MAX_LENGTH = 600;
export const ACCOUNT_NAME_MIN_LENGTH = 1;
export const ACCOUNT_NAME_MAX_LENGTH = 320;
export const MAX_FILTER_WORDS_LENGTH = 1000;
export const PARTY_LIMIT = 5000;
export const FRIENDS_LIMIT = 25000;
...
export const SCALING_LIMIT = [-20, 20];
export const SWAP_TIMEOUT = 1000;
export const MAP_LOAD_SAVE_TIMEOUT = 5000;

export const HIDES_PER_PAGE = 20;

export const LATEST_CHARACTER_LIMIT = 6;
export const BASE_CHARACTER_LIMIT = 200;
export const ADDITIONAL_CHARACTERS_SUPPORTER1 = 50;
export const ADDITIONAL_CHARACTERS_SUPPORTER2 = 100;
export const ADDITIONAL_CHARACTERS_SUPPORTER3 = 150;
export const ADDITIONAL_CHARACTERS_PAST_SUPPORTER = 25;
...
export const HOUSE_ENTITY_LIMIT = 2000000;
...
export const GENERAL_RULES = [
    `18+ stuff only on party island/house`,
	`Be kind to others`,
	`Don't spam`,
