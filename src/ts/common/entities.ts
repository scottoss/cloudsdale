...
export const muffin = collectable(n('muffin'), sprites.muffin, 0, mixPickable(31, 50));

export const heart = collectable(n('heart'), sprites.heart, 0, mixPickable(31, 50));

export const rose2 = collectable(n('rose2'), sprites.rose2, 0, mixPickable(31, 50));

export const valentinesign = collectable(n('valentinesign'), sprites.valentinesign, 0, mixPickable(31, 50));

export const tardis = collectable(n('tardis'), sprites.tardis, 0, mixPickable(31, 50));


export const logo = collectable(n('logo'), sprites.logo, 0, mixPickable(31, 50));

export const flowerbl = collectable(n('flowerbl'), sprites.flowerbl, 0, mixPickable(31, 50));

export const flowery = collectable(n('flowery'), sprites.flowery, 0, mixPickable(31, 50));

export const lemonade = collectable(n('lemonade'), sprites.lemonade, 0, mixPickable(31, 50));

export const cup = collectable(n('cup'), sprites.cup, 0, mixPickable(31, 50));
...
export const coffeedisp = doodad(n('coffeedispenser'), sprites.cupdispenser, 16, 32, 0,
	...boxParts,
	mixInteractAction(InteractAction.GiveCup));
...
export const lemonadedisp = doodad(n('lemonadedispenser'), sprites.lemonadedispenser, 16, 32, 0,
	...boxParts,
	mixInteractAction(InteractAction.GiveLemonade));
...
export const placeableEntities: { type: number; name: string; }[] = [
	...
	{ type: bench1.type, name: 'bench' },
	{ type: coffeedisp.type, name: 'coffeedispenser' },
	{ type: lemonadedisp.type, name: 'lemonadedispenser' },
	{ type: tree3.type, name: 'tree' },
	{ type: flowery.type, name: 'flower yellow' },
	{ type: flowerbl.type, name: 'flower blue' },
	{ type: fence1.type, name: 'fence' },
	{ type: heart.type, name: 'heart' },
	{ type: rose.type, name: 'rose' },
	{ type: rose2.type, name: 'rose2' },
	{ type: pine2.type, name: 'pine' },
	{ type: torchOn.type, name: 'torch' },
];
